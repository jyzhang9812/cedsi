<template>
  <div id="stu-management">
    ...
    ></el-pagination>
    <!-- 批量导入模态框 -->
    <el-dialog title="批量导入学生" :visible.sync="dialogVisible" width="30%">
      <el-col :span="4" style="margin-left: 15px;line-height:40px;">文件选择：</el-col>
      ...
      <el-row>
        <el-col :span="4" style="margin-left: 15px;line-height:40px;">文件名称：</el-col>
        <el-col :span="14">
