<template>
  <div id="coursecard">
    ...
    <el-row v-else style="padding-top:15px;">
      <el-col v-for="(item,index) in currentList" :key="index" :span="6" :push="1" :offset="1"
        ...
        <div class="outside">
          ...
          <button class="btn" @click='jmp(index)'>开始学习</button>
        </div>
      </el-col>
    </el-row>
    <el-pagination class="pagination" :page-size="limit" v-if="currentList.length" background layout="prev, pager, next"
