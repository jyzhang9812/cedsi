...
export default {
  data() {
    return {
      type: 0,
      activitybgUrl:
        "https://cedsi.s3.cn-northwest-1.amazonaws.com.cn/static/activitybg.png",
      activitydetialUrl:
        "https://cedsi.s3.cn-northwest-1.amazonaws.com.cn/static/activitydetial.png"
    };
  },
  methods: {
    payment() {
