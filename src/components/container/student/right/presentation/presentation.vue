  ...
  data() {
    return {
      ...
      superurl: [
        {
          url:
            "https://www.tynker.com/image/dashboard/student/learn/tutorials/nasa-design-a-mission-patch.png?width=600&height=400&mode=cover&format=jpg&quality=75&cache=1m&v=1",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/hour-of-code/2017/mod-minecraft.png?width=600&height=400&mode=cover&format=jpg&quality=75&cache=1m&v=1",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/hour-of-code/2018/crystal-clash/crystal-clash.png?width=600&height=400&mode=cover&format=jpg&quality=75&cache=1m&v=1",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/hour-of-code/2016/spin-draw/spin-draw-1.png?width=600&height=400&mode=cover&format=jpg&quality=75&cache=1m&v=1",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/ide/imgs/templates/new.png?width=600&height=400&mode=cover&format=jpg&quality=75&cache=1m&v=1",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/hour-of-code/2017/dragon-blast/dragon-blast-1.png?width=600&height=400&mode=cover&format=jpg&quality=85&cache=1m&v=1",
          img: ""
        }
      ],
      calleft: 0,
      i: -1,
      curId: 0,
      items: [{ item: "视频" }, { item: "PPT" }, { item: "文档" }],
      contents: [
        [
          {
            name: "video1",
            src: "../../" + this.$store.state.url + "presentation/mp4.png"
          },
          {
            name: "video2",
            src: "../../" + this.$store.state.url + "presentation/mp4.png"
        ...
        [
          {
            name: "ppt1",
            src: "../../" + this.$store.state.url + "presentation/ppt.png"
          },
          {
            name: "ppt2",
            src: "../../" + this.$store.state.url + "presentation/ppt.png"
        ...
        [
          {
            name: "word1",
            src: "../../" + this.$store.state.url + "presentation/word.png"
          },
          {
            name: "word2",
            src: "../../" + this.$store.state.url + "presentation/word.png"
