<template>
  <div id="community" class="body">
    ...
    <div class="row main">
      <div class="col-md-3" v-show="curId!=1" v-for="(item,index) in user_url" :key="'info-'+index">
          ...
          <div class="inside">
            ...
            <div class="details">
              ...
              <div class="detail_item">
                <div class="left">
                  <h5>
                    <strong>作品名{{item.course_name}}</strong>
                  </h5>
                  <p>
                    by
                    <a>作者姓名</a>
      ...
      <div class="col-md-3" v-show="curId==1" v-for="(item,index) in user_url" :key="index">
        <div class="user_card">
          <div class="details">
            ...
            <h5>
              <strong>作者姓名{{item.user_name}}</strong>
            </h5>
            <div class="detail_item">
              <div>
  ...
  data() {
    return {
      ...
      user_url: [
        {
          url:
            "https://www.tynker.com/image/course-card/vertical/minecraft-starter.png",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/course-card/vertical/turings-tower.png",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/course-card/vertical/cannon-crasher-physics-game.png",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/course-card/vertical/the-drone-menace-arcade-game.png",
          img: ""
        },
        {
          url:
            "https://www.tynker.com/image/course-card/vertical/gravity-sling-advanced-projectile-physics.png",
          img: ""
        }
      ],
      contents: [],
