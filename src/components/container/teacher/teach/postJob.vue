<template>
  <div id="teacher-postJob">
    <div class="body" v-show="!addShown">
        ...
        <el-table v-if="tableData" :data="tableData" style="width: 100%">
          ...
          <el-table-column align="center" label="操作" width="280">
            <template slot-scope="scope">
              ...
              <el-button size="mini" type="success" :disabled="scope.row.IS_PUBLISH" @click="postJob(scope.row)">发布
              </el-button>
      ...
      <el-pagination :page-size="limit" background layout="prev, pager, next" :total="homeworkList.length"
      ...
      <div class="form-size">
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-form-item label="截止时间">
            <el-col :span="11">
              <el-date-picker type="date" placeholder="选择日期" v-model="form.date1" value-format="yyyy-MM-dd HH:mm:ss"
                style="width: 100%;"></el-date-picker>
            </el-col>
            <el-col class="line" :span="2">-</el-col>
            <el-col :span="11">
              <el-time-picker placeholder="选择时间" v-model="form.date2" value-format="yyyy-MM-dd HH:mm:ss"
          ...
          <el-form-item label="作业封面">
            <el-upload class="avatar-uploader" :http-request="loadHomeworkCover" action="#" :show-file-list="true"
              :limit="1">
    ...
    methods: {
      ...
      postJob(line) {
        ...
        instance
          ...
          .then(res => {
            console.log(res);
            res.status === 200 ? "发布成功!" : "发布失败!"
            if (res.status === 200) { this.$message({ message: '发布成功!', type: 'success' }); }
            else {
