  ...
  <div id="remark">
    ...
    <div class="second-floor">
      <div class="second-floor-child">
        ...
        <i class="el-icon-arrow-down second-floor-child-icon"></i>
      </div>
      <div class="second-floor-child">
        <select
        ...
        >
          <option
            data-index="index"
            v-for="(chapterName, index) in classNameList[classIndex]
              .chapterNameList"
    ...
    <div class="forth-floor">
        ...
        <el-table-column align="center" label="操作" width="280">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              @click="openCommentDialog(scope.$index)"
              >点评</el-button
            >
          </template>
        </el-table-column>
      ...
      <el-dialog
        v-if="dialogHomeworkVisible"
        :visible.sync="dialogHomeworkVisible"
        width="58%"
        ...
        <el-row :gutter="20">
          <el-col :span="16">
            ...
            <iframe
              ...
              frameborder="no"
              border="0"
              :src="`${scratchUrl}${currentList[curWork].HW_URL}`"
            ></iframe>
          </el-col>
        ...
        <el-form ref="form" :model="form" label-width="100px">
          ...
          <el-form-item label="评分">
            <i
              ...
              :class="item ? 'el-icon-star-on' : 'el-icon-star-off'"
              @click="changeStarNum(index)"
            ></i>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="remarkWork(curWork)"
              >确定</el-button
            >
          </el-form-item>
        </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      iFrameShow: false,
      scratchUrl: "https://cedsi.s3.cn-northwest-1.amazonaws.com.cn",
      limit: 10,
      curWork: 0,
      form: {
        star_num: 0,
  ...
  methods: {
    ...
    changeOption: function(e) {
      ...
      if (type === "class") {
        ...
        console.log("章节切换");
        this.pullHomeworkWithId(
          this.classNameList[this.classIndex].id,
    ...
    remarkWork() {
      ...
      instance
        ...
        .then(res => {
          ...
          // if(res.data)
          this.pullHomeworkWithId(
            this.currentList[this.curWork].CLASS_ID,
            this.currentList[this.curWork].HW_ID
          );
        })
        .catch(err => {
          console.log(err);
        ...
        .then(res => {
          ...
          for (let i = 0; i < res.data.length; i++) {
            ...
            for (let j = 0; j < res.data[i].CHAPTERS.length; j++) {
              this.classNameList[i].chapterNameList.push(
                res.data[i].CHAPTERS[j]
              );
            }
          }
    ...
    pullHomeworkWithId(classId, chapterId) {
      ...
      instance
        .get(
          "/teacher/class/" + classId + "/homework?cpId=" + chapterId,
          config
        )
        .then(res => {
          console.log(res);
